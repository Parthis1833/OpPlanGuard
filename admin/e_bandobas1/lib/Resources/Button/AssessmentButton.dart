...
class  AssesmentButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return FloatingActionButton(backgroundColor: const Color.fromARGB(100, 28, 54, 105),
    onPressed: () {
    showDialog(
    context: context,
    ...
    padding: const EdgeInsets.only(left:20,top:25,right:0,bottom:0,) ,
