...
import 'package:e_bandobas/app/modules/pointlist/controllers/pointlist_controller.dart';
...
class CustomRouteManager {
  ...
  static void POINTLIST({arguments}) {
    Get.delete<PointlistController>();
    Get.toNamed(Routes.POINTLIST, arguments: arguments);
  }
