class APIConstants {
  ...
  static const POLICE_URL_UPDATE = BASE_URL + POLICE; // NEED TO APPEND POLICE ID
  static const POLICE_URL_DELETE = BASE_URL + POLICE; // NEED TO APPEND POLICE ID
  static const POLICE_URL_UPLOAD_FROM_EXCEL = BASE_URL + POLICE + "upload-from-excel"; // FOR POST REQUEST
  static const POLICE_READ_SPECIFIC = BASE_URL + POLICE; // NEED TO APPEND POLICE ID
  static const POLICE_OFFICER_DATA = BASE_URL + POLICE + "officer-data"; // FOR GET REQ

  // POLICE STATIONS APIS
  static const POLICESTATION = "/police-station/";
  static const POLICESTATION_URL = BASE_URL + POLICESTATION; //
  static const POLICESTATION_URL_CREATE = BASE_URL + POLICESTATION; // for post request
  static const POLICESTATION_URL_UPDATE = BASE_URL + POLICESTATION; // need to append id with put req
  static const POLICESTATION_URL_DELETE = BASE_URL + POLICESTATION; // append id with del req
  static const POLICESTATION_URL_UPLOAD_FROM_EXCEL = BASE_URL + POLICESTATION + "upload-from-excel"; // get req
  static const POLICESTATION_READ_SPECIFIC = BASE_URL + POLICESTATION; // append id

  // POINT APIS
  static const POINT = "/point/";
  static const POINT_URL = BASE_URL + POINT; // FOR GET REQUEST
  static const POINT_URL_CREATE = BASE_URL + POINT; // FOR POST REQUEST
  static const POINT_URL_UPDATE = BASE_URL + POINT; // NEED TO Append id with put req
  static const POINT_URL_DELETE = BASE_URL + POINT; // NEED TO Append id with del req
  // static const POINT_URL_UPLOAD_FROM_EXCEL =
  static const POINT_READ_SPECIFIC = BASE_URL + POINT; // Need to Append id with get req
  ...
  static const EVENT_READ_SPECIFIC = BASE_URL + EVENT; // need to append id with get req
  ...
  static const DESIGNATION_URL_UPDATE = BASE_URL + DESIGNATION; // need to append id with put req
  static const DESIGNATION_URL_DELETE = BASE_URL + DESIGNATION; // need to append id with delete
  // static const DESIGNATION_URL_UPLOAD_FROM_EXCEL = BASE_URL + DESIGNATION;
  static const DESIGNATION_READ_SPECIFIC = BASE_URL + DESIGNATION; // need to append id with get req
  static const DESIGNATION_FIND_BY = BASE_URL + DESIGNATION + "find-by"; // get req
  ...
  static const ASSIGNPOLICE_URL_CREATE_V2 = BASE_URL + ASSIGNPOLICE; // post Req,
  static const ASSIGNPOLICE_URL_UPDATE = BASE_URL + ASSIGNPOLICE; // append id for put req
  static const ASSIGNPOLICE_URL_DELETE = BASE_URL + ASSIGNPOLICE; // append id for delete req
  // static const ASSIGNPOLICE_URL_UPLOAD_FROM_EXCEL = BASE_URL + ASSIGNPOLICE; // append id for
  static const ASSIGNPOLICE_READ_SPECIFIC = BASE_URL + ASSIGNPOLICE; // append if for get req
  ...
  static const ASSIGNPOLICE_POLICE_IN_POINT_AND_EVENT = BASE_URL + ASSIGNPOLICE + "police-in-point-event";
  ...
  static const EVENT_POLICE_COUNT_READ_SPECIFIC_EVENT = BASE_URL + EVENT_POLICE_COUNT;
  static const EVENT_POLICE_COUNT_DESIGNATION_COUNTS = BASE_URL + EVENT_POLICE_COUNT + "designation-counts/"; // append event id
  static const EVENT_POLICE_COUNT_ASSIGNMENTS = BASE_URL + EVENT_POLICE_COUNT + "assignments";
